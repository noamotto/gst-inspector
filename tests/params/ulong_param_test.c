...
int main(int argc, char *argv[])
{
    ...
    gst_type_reader_fill_type(ulong_spec, value, dictionary);
    ...
    g_assert_cmpstr(gst_dictionary_get_string(dictionary, KEY_TYPE), ==, "Unsigned Long");
