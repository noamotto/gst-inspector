...
int main(int argc, char *argv[])
{
    ...
    check_signal(gst_value_get_structure(gst_array_get_value(&result, 0)), "no-retval", g_type_name(G_TYPE_NONE), 2, args0);
    check_signal(gst_value_get_structure(gst_array_get_value(&result, 1)), "no-ptr", "gint", 2, args1);
    check_signal(gst_value_get_structure(gst_array_get_value(&result, 2)), "ptr", "GstElement *", 2, args2);
