...
TypeResolver::TypeResolver()
{
    ...
    m_reader_map[G_TYPE_PARAM_BOXED] = new BoxedTypeReader;
    m_reader_map[G_TYPE_PARAM_DOUBLE] = new DoubleTypeReader;
    m_reader_map[G_TYPE_PARAM_ENUM] = new EnumTypeReader;
    m_reader_map[G_TYPE_PARAM_FLAGS] = new FlagsTypeReader;
    m_reader_map[G_TYPE_PARAM_FLOAT] = new FloatTypeReader;
    m_reader_map[GST_TYPE_PARAM_FRACTION] = new FractionTypeReader;
    ...
    m_reader_map[G_TYPE_PARAM_OBJECT] = new ObjectTypeReader;
    m_reader_map[G_TYPE_PARAM_POINTER] = new PointerTypeReader;
